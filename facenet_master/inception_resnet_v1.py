...
# 参考： https://github.com/nyoki-mtl/keras-facenet/blob/master/code/inception_resnet_v1.py
...
def _inception_resnet_block(x, scale, block_type, block_idx, activation='relu'):
    ...
    up = conv2d_bn(mixed, K.int_shape(x)[channel_axis], 1, activation="", use_bias=True,
...
def InceptionResNetV1(input_shape=(160, 160, 3),
    ...
    for block_idx in range(1, 6):
        x = _inception_resnet_block(x,
                                    ...
                                    block_type='Block8',
                                    block_idx=block_idx)
    x = _inception_resnet_block(x, scale=1., activation="", block_type='Block8', block_idx=6)
